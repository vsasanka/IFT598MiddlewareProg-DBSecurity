// importing loan ledger schema
const Loan = require('../model/loanLedgerSchema');
const APIFeatures = require('../dataBaseManager/loanDBContext');

// all the methods and variables help through the CRUD operations for the loan ledger table 
