// importing customer schema
const Loan = require('../model/customerSchema');
const APIFeatures = require('../dataBaseManager/loanDBContext');

// all the methods and variables help through the CRUD operations for the customers table 
